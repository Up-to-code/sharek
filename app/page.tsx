      ...
      <Suspense fallback={<p>Loading weather...</p>}>
        <div className="container  flex justify-center items-center h-full min-h-[500px] flex-col  gap-14">
          ...
          <div className="flex gap-10  w-72   justify-center items-center font-black">
            ...
            <Link
              href={"/Sign_up"}
              className="flex border-[2px] hover:shadow-none  border-black py-2 px-6 shadow_  bg-background text-foreground  hover:bg-secondary font-bold  hover:text-white"
            >
              Sign up
            </Link>
          </div>
